      ...
      <main className="pt-24 pb-16 px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-medium text-slate-700 dark:text-slate-300">Phone / WhatsApp</h3>
                    <a 
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-medium text-slate-700 dark:text-slate-300">Location</h3>
                    <p className="text-slate-600 dark:text-slate-400">Musanze, Rwanda</p>
                  </div>
                </div>
              </div>

              <div className="mt-10">
                <h3 className="text-lg font-medium text-slate-800 dark:text-white mb-4">Connect with me</h3>
                <div className="flex space-x-4">
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="w-10 h-10 rounded-full bg-pink-100 dark:bg-pink-900/30 flex items-center justify-center text-pink-600 dark:text-pink-400 hover:bg-pink-200 dark:hover:bg-pink-800/50 transition-colors"
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="w-10 h-10 rounded-full bg-green-100 dark:bg-green-900/30 flex items-center justify-center text-green-600 dark:text-green-400 hover:bg-green-200 dark:hover:bg-green-800/50 transition-colors"
                    aria-label="WhatsApp"
                  >
            ...
            {/* Contact Form */}
            <div className="bg-white dark:bg-slate-800 p-8 rounded-xl shadow-sm border border-slate-100 dark:border-slate-700 transition-colors duration-200">
              <h2 className="text-2xl font-bold text-slate-800 dark:text-white mb-6">Send Me a Message</h2>
              
              {submitStatus && (
                <div className={`p-4 mb-6 rounded-lg ${submitStatus.success ? 'bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-200' : 'bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-200'}`}>
              ...
              >
                ...
                <div>
                  ...
                  <input
                    ...
                    name="name"
                    required
                    className="w-full px-4 py-2 border border-slate-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition bg-white dark:bg-slate-700 text-slate-800 dark:text-white"
