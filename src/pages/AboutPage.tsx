        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            ...
            <div className="bg-blue-50 p-6 rounded-xl">
              ...
              <h3 className="text-xl font-semibold text-slate-800 mb-2">Expertise</h3>
              <p className="text-slate-600">
          ...
          <div className="bg-white p-8 rounded-xl border border-slate-100 shadow-sm">
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-2xl font-bold text-slate-800">Career Goal</h2>
            </div>
            <blockquote className="text-lg text-slate-700 italic border-l-4 border-blue-500 pl-6 py-2">
